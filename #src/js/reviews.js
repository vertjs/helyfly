let reviewsArr = [
  { photo: "./img/reviews/1.svg",
    name: "Валерия Антонова",
    occupation: "Арт-директор",
    review: ["./img/icons/stars.svg", "Супер! Я бы заказала съемку снова!"],
  ...
  { photo: "./img/reviews/2.svg",
    name: "Виталий Петров",
    occupation: "Фотограф",
    review: ["./img/icons/stars.svg", "Супер! Я бы заказал съемку снова!"],
